...
public class EditarMetodologia extends JFrame {
	...
	public void editarMetodologia(int id, String titulo) {
		try {
			...
			JOptionPane.showMessageDialog(null,"Alteração realizada com sucesso.",nomeJanela, JOptionPane.INFORMATION_MESSAGE);

		} catch (Exception ex) {
			JOptionPane.showMessageDialog(null,"Erro ao atualizar dados da metodologia.",nomeJanela, JOptionPane.INFORMATION_MESSAGE);
			ex.printStackTrace();
		}
	}
