...
public class ListarPessoas extends JFrame {
	...
	public ListarPessoas() {
		...
		int g = 10,
			...
			//janelaAltura = ((alturaPanel+distanciaSuperior)*2-g/2)-alturaPanel/2,
		...
		pSemTarefa.setBounds			(distanciaLateral, distanciaSuperior*4, largura*2+distanciaLateral, altura);
